...
#ifndef THREADQA_SWIFT_H
#define THREADQA_SWIFT_H
...
# undef any
# pragma clang attribute push(__attribute__((external_source_symbol(language="Swift", defined_in="ThreadQA",generated_declaration))), apply_to=any(function,enum,objc_interface,objc_category,objc_protocol))
...
SWIFT_CLASS("_TtC8ThreadQA24AddNewUserViewController")
...
- (void)viewDidLoad;
- (IBAction)cancelAddUser:(id _Nonnull)sender;
...
SWIFT_CLASS("_TtC8ThreadQA11AppDelegate")
...
SWIFT_CLASS("_TtC8ThreadQA17HomeTableViewCell")
...
SWIFT_CLASS("_TtC8ThreadQA18HomeViewController")
@interface HomeViewController : UIViewController <UITableViewDataSource, UITableViewDelegate>
@property (nonatomic, weak) IBOutlet UITableView * _Null_unspecified userView;
- (void)viewDidLoad;
...
SWIFT_CLASS("_TtC8ThreadQA19LoginViewController")
...
- (void)viewDidLoad;
- (IBAction)alert:(id _Nonnull)sender;
- (IBAction)emailField:(id _Nonnull)sender;
- (IBAction)passwordField:(id _Nonnull)sender;
- (IBAction)loginUser:(id _Nonnull)sender;
- (nonnull instancetype)initWithNibName:(NSString * _Nullable)nibNameOrNil bundle:(NSBundle * _Nullable)nibBundleOrNil OBJC_DESIGNATED_INITIALIZER;
- (nullable instancetype)initWithCoder:(NSCoder * _Nonnull)coder OBJC_DESIGNATED_INITIALIZER;
@end
...
SWIFT_CLASS("_TtC8ThreadQA21ProfileViewController")
...
SWIFT_CLASS("_TtC8ThreadQA22RegisterViewController")
@interface RegisterViewController : UIViewController <UITextFieldDelegate>
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified firstName;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified lastName;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified email;
@property (nonatomic, weak) IBOutlet UITextField * _Null_unspecified password;
@property (nonatomic, weak) IBOutlet UISwitch * _Null_unspecified clickButton;
- (void)viewDidLoad;
- (BOOL)textFieldShouldReturn:(UITextField * _Nonnull)textField SWIFT_WARN_UNUSED_RESULT;
- (IBAction)register:(UIButton * _Nonnull)sender;
- (IBAction)onOff:(UISwitch * _Nonnull)sender;
...
SWIFT_CLASS("_TtC8ThreadQA13SceneDelegate")
...
@interface UIViewController (SWIFT_EXTENSION(ThreadQA))
- (void)dismissKeyboard;
@end


SWIFT_CLASS("_TtC8ThreadQA24UserDetailViewController")
